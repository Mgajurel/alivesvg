...
const ANIMATION_FILTERS: Array<AnimationPreset | "all"> = [
    "all",
    "spin",
    "bounce",
    "pulse",
...
const ANIMATION_LABELS: Record<AnimationPreset | "all", string> = {
    all: "All Presets",
    fade: "Fade",
    scale: "Scale",
    slide: "Slide",
...
export default function LibraryPage() {
    ...
    const [animationFilter, setAnimationFilter] = useState<AnimationPreset | "all">("all");
            ...
            <main className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-12 pt-6 sm:px-6 lg:px-8 lg:pt-8">
                ...
                >
                    ...
                    <motion.div variants={rise}>
                        <Button asChild className="rounded-full !bg-[#ff6d3a] !text-white px-5 font-semibold shadow-[0_10px_24px_rgba(255,109,58,0.3)] hover:!bg-[#ea5f2f]">
